...
public class ClientPageDataEndpoint {
	...
	public FbPage addPage(@Named("clientpageid") String clientpageid, FbPage newPage) {
		...
		System.out.println("addPage hit");
		
		System.out.println(newPage.getName());
	...
	public FbPage getPageExample() {
				
		return new FbPage("UCD Events", "http://www.facebook.com/UCDEvents", "197528567092983");
	}
}